...
MySQL - 8.0.15 : Database - white_jotter
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`white_jotter` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `category`(`id`,`name`) values (1,'文学'),(2,'流行'),(3,'文化'),(4,'生活'),(5,'经济'),(6,'科技');
